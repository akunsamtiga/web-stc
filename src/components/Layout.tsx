...
export const Layout: React.FC = () => {
    ...
    `}>
      ...
      <div className="px-3 py-3 border-t border-slate-100 flex-shrink-0">
        <button
          ...
          className="w-full flex items-center gap-2.5 px-3 py-2 text-sm font-medium
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Mobile topbar */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b border-slate-200 h-14">
